...
public class CameraManager : MonoBehaviour
{
    ...
    public float cameraCollisionOffSet = 0.2f; //how much the camera will jump off the object it collides with
    public float minimCollisionOffSet = 0.2f;
    ...
    private void HandleCameraCollisions()
    {
        ...
        if(Mathf.Abs(targetPosition) < minimCollisionOffSet)
        {
            targetPosition = targetPosition - minimCollisionOffSet;
        }
